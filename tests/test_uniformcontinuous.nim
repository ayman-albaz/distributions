...
suite "UniformContinuousDistribution":
  ...
  test "UniformContinuousDistribution(0.0, 1.0).pdf(0.5)":
    let uniform_continuous_dist = initUniformContinuousDistribution(0.0, 1.0)
    check uniform_continuous_dist.pdf(0.5).round(r1) == 1.0.round(r1)
  ...
  test "UniformContinuousDistribution(-1.0, 1.0).ppf(0.25)":
  ...
  test "UniformContinuousDistribution(-1.0, 1.0).ppf(0.50)":
    let uniform_continuous_dist = initUniformContinuousDistribution(-1.0, 1.0)
    check uniform_continuous_dist.ppf(0.50).round(r1) == 0.0.round(r1)

  test "UniformContinuousDistribution(-1.0, 1.0).ppf(0.75)":
    let uniform_continuous_dist = initUniformContinuousDistribution(-1.0, 1.0)
